...
<!DOCTYPE html>
<head>
    <title>BIBLIOTECA | AÑADIR COLECCIÓN</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <section class="fondo_claro" id="autores">
        <div class="conte">
            ...
            <form action="../actbbdd/insertColeccion.php" method="post" enctype="multipart/form-data">
                <div class="formulario">
                    ...
                    <input type="submit" value="añadir colección">
