...
<!DOCTYPE html>
<head>
    <title>BIBLIOTECA | AÑADIR GENERO</title>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="cabecera">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="../ver/verGeneros.php">genero</a></li>
    ...
    <section class="fondo_claro" id="autores">
        <div class="conte">
            <h2>Nuevo Genero</h2>
            <form action="../actbbdd/insertGenero.php" method="post" enctype="multipart/form-data">
                <div class="formulario">
                     <fieldset class="data">
                         <h3>Añadir datos:</h3>
                          <hr>
                         <label for="nombre">Nombre: </label>
                         <input id="nombre" type="text" name="nombre" placeholder="añade genero..." autofocus required>
                         <br>
